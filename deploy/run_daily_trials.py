...
Then run this script with --server flag:
    python run_daily_trials.py trial_params/nba-moneyline.yaml --server http://localhost:8000

Usage:
    python run_daily_trials.py trial_params/nba-moneyline.yaml
    python run_daily_trials.py trial_params/nfl-moneyline.yaml --date 2025-01-20
    python run_daily_trials.py trial_params/nba-moneyline.yaml --server http://localhost:8000
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  %(prog)s trial_params/nba-moneyline.yaml
  %(prog)s trial_params/nfl-moneyline.yaml --date 2025-01-20
  %(prog)s trial_params/nba-moneyline.yaml --server http://localhost:8000
        """,
    )
