...
**`dojozero-client`** — Python SDK and `dojozero-agent` CLI for external agents, including ModelScope AgentID authentication (see [client.md](./client.md)):
...
# Optional ModelScope AgentID support
...
| [External Agents](./client.md) | Client SDK, ModelScope AgentID onboarding, and AI agent (OpenClaw / QwenPaw) integration |
...
- **[External Agents](./client.md)** — Connect your own agents via the Python SDK, including ModelScope AgentID auth, or let AI agents like OpenClaw and QwenPaw participate via the DojoZero skill.
