...
TEAM_NAME_VARIATIONS: dict[str, list[str]] = {
    "MIA": ["mia", "heat", "miami heat", "miami"],
    "ORL": ["orl", "magic", "orlando magic", "orlando"],
    "LAL": ["lal", "lakers", "los angeles lakers", "la lakers"],
    "BOS": ["bos", "celtics", "boston celtics", "boston"],
    "GSW": ["gsw", "warriors", "golden state warriors", "golden state"],
    "PHX": ["phx", "suns", "phoenix suns", "phoenix"],
    "OKC": ["okc", "thunder", "oklahoma city thunder", "oklahoma city"],
    "DET": ["det", "pistons", "detroit pistons", "detroit"],
    "TOR": ["tor", "raptors", "toronto raptors", "toronto"],
    "CHI": ["chi", "bulls", "chicago bulls", "chicago"],
    "NYK": ["nyk", "knicks", "new york knicks", "ny knicks"],
    "BKN": ["bkn", "nets", "brooklyn nets", "brooklyn"],
    "PHI": ["phi", "76ers", "sixers", "philadelphia 76ers", "philadelphia"],
    "ATL": ["atl", "hawks", "atlanta hawks", "atlanta"],
    "CHA": ["cha", "hornets", "charlotte hornets", "charlotte"],
    "CLE": ["cle", "cavaliers", "cavs", "cleveland cavaliers", "cleveland"],
    "DAL": ["dal", "mavericks", "mavs", "dallas mavericks", "dallas"],
    "DEN": ["den", "nuggets", "denver nuggets", "denver"],
    "HOU": ["hou", "rockets", "houston rockets", "houston"],
    "IND": ["ind", "pacers", "indiana pacers", "indiana"],
    "LAC": ["lac", "clippers", "la clippers", "los angeles clippers"],
    "MEM": ["mem", "grizzlies", "memphis grizzlies", "memphis"],
    "MIN": ["min", "timberwolves", "wolves", "minnesota timberwolves", "minnesota"],
    "NOP": ["nop", "pelicans", "new orleans pelicans", "new orleans"],
    "POR": ["por", "trail blazers", "blazers", "portland trail blazers", "portland"],
    "SAC": ["sac", "kings", "sacramento kings", "sacramento"],
    "SAS": ["sas", "spurs", "san antonio spurs", "san antonio"],
    "UTA": ["uta", "jazz", "utah jazz", "utah"],
    "WAS": ["was", "wizards", "washington wizards", "washington"],
}
