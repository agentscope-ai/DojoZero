...
class TavilySearchAdapter:
    ...
    def _normalize_results(self, tavily_result: dict[str, Any], query: str) -> dict[str, Any]:
...
class WebSearchAPI(ExternalAPI):
    ...
    async def fetch(self, endpoint: str = "search", params: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        if endpoint == "search":
            ...
            if self.custom_search_fn:
                ...
                if inspect.iscoroutinefunction(self.custom_search_fn):
                    ...
                    result = await asyncio.to_thread(self.custom_search_fn, **search_params)
