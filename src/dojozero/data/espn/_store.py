...
class ESPNStore(DataStore):
    ...
    def __init__(
        ...
        self._state = BaseGameStateTracker()
    ...
    def _parse_scoreboard(
        ...
        for game in scoreboard_events:
            ...
            if status_code != previous_status:
                # Game started
                if (
                    status_code == BaseGameStateTracker.STATUS_IN_PROGRESS
                    and previous_status != BaseGameStateTracker.STATUS_IN_PROGRESS
                ):
                    events.append(
                        GameStartEvent(
                            timestamp=timestamp,
                ...
                # Game ended
                if status_code == BaseGameStateTracker.STATUS_FINAL:
    ...
    def _parse_summary(
        ...
        Emits BaseGameUpdateEvent with boxscore data.
        """
        events: list[DataEvent] = []
    ...
    def _parse_plays(
        ...
        Emits BasePlayEvent for each new play.
        """
        events: list[DataEvent] = []
