...
def get_proxy() -> str | None:
    ...
    """
    return os.getenv("AGENT_PROXY_URL")


def with_proxy(func: F) -> F:
    """Decorator to ensure AGENT_PROXY_URL is set up for NBA API calls.

    This decorator:
    1. Checks if AGENT_PROXY_URL is available
...
def get_games_by_date_range(
    ...
    Args:
        ...
        proxy: Optional proxy URL (automatically set from AGENT_PROXY_URL env var if not provided)
