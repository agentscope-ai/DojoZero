...
class TavilySearchAdapter:
    ...
    def __init__(self, api_key: str | None = None):
        ...
        Args:
            api_key: Tavily API key (defaults to AGENT_TAVILY_API_KEY env var)
        """
        ...
        self.api_key = api_key or os.getenv("AGENT_TAVILY_API_KEY")
        if not self.api_key:
            raise ValueError(
                "AGENT_TAVILY_API_KEY not provided and not found in environment variables. "
    ...
    async def fetch(
        ...
        if endpoint == "search":
            ...
            raise ValueError(
                ...
                "and set AGENT_TAVILY_API_KEY in your .env file."
            )
        else:
